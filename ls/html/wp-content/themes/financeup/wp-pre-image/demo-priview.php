 ...
 * @return bool
 */
function financeup_pre_demo() {
	$ti_theme = wp_get_theme();
	$theme_name = $ti_theme ->get( 'TextDomain' );
	$active_theme = financeup_get_raw_option( 'template' );
	return apply_filters( 'financeup_pre_demo', ( $active_theme != strtolower( $theme_name ) && ! is_child_theme() ) );
}
 ...
 * @return bool|mixed
 */
function financeup_get_raw_option( $opt_name ) {
